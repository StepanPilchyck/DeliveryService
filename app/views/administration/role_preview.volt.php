...
<table class="table table-list_grid_1" width="100%">
    <tbody>
        ...
        <tr>
            <td align="left">
                <span><?php echo $item['name']; ?> (<a href="#" title="Колличество связей с Пользователями"><?php echo $item['from_users']; ?></a>) <?php echo $item['description']; ?></span>
            </td>
            <td>
                <a href="/administration/role/edit/<?php echo $item['id']; ?>">
                    <div class="panel_edit">
                        &nbsp;
                    </div>
                </a>
                
                <a href="/<?php echo $item['role_id']; ?>" onClick="jsAsync.ShowModal(event, '<p>Подтвердите удаление</p>', '<p>Вы действительно хотите удалить роль <b><?php echo $item['name']; ?></b> ?</p>', 'Да', 'Нет', 'delete', '', '<?php echo $item['id']; ?>');">
