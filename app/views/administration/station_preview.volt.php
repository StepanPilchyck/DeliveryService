...
<table class="table table-list_grid_1" width="100%">
    <tbody>
        ...
        <tr>
            ...
            <td align="left">
                <span><?php echo $item['country_name']; ?></span>
            </td>
            <td align="left">
                <span><?php echo $item['station_status_name']; ?></span>
            </td>
            <td align="center">
                <span>
                    <a href="/<?php echo $item['id']; ?>" onClick="jsAsync.ShowModal(event, '<p>Подтвердите удаление</p>', '<p>Вы действительно хотите удалить запись <b><?php echo $item['name']; ?></b> ?</p>', 'Да', 'Нет', 'delete', '', '<?php echo $item['id']; ?>');">
                        Удалить
                    </a>(
                    ...
                    <a href="#" title="Колличество связей с Реестрами"><?php echo $item['from_registry']; ?></a>,
                    <a href="#" title="Колличество связей с Манифестами"><?php echo $item['from_manifests']; ?></a>
                    <a href="#" title="Колличество связей с кэшом Адресной книги"><?php echo $item['from_persons_cache']; ?></a>
                )</span>
            </td>
            <td align="center">
                <span>
                    <a href="/administration/station/edit/<?php echo $item['id']; ?>">
