...
<table class="table table-list_grid_1" width="100%">
    <tbody>
        ...
        <tr>
            ...
            <td align="left">
                <span><?php echo $item['last_name']; ?> <?php if ($item['first_name']) { ?><?php echo $item['first_name']; ?> <?php } ?>  <?php if ($item['middle_name']) { ?><?php echo $item['middle_name']; ?> <?php } ?></span>
            </td>
            <td align="left">
                <span><?php echo $item['role_name']; ?></span>
            </td>
            <td align="left">
                <span><?php echo $item['station_name']; ?></span>
            </td>
            <td align="left">
                <span><?php if ($item['blocked']) { ?> Заблокирован <?php } else { ?> Активен <?php } ?></span>
            </td>
            <td align="left">
                <span><?php echo $item['date_on_add']; ?></span>
            </td>
            <td align="center">
                <span><?php echo $item['date_on_last_login']; ?></span>
            </td>
            <td align="center">
                <span>
                    <a href="/<?php echo $item['id']; ?>" onClick="jsAsync.ShowModal(event, '<p>Подтвердите удаление</p>', '<p>Вы действительно хотите удалить запись <b><?php echo $item['first_name']; ?> <?php echo $item['last_name']; ?></b> ?</p>', 'Да', 'Нет', 'delete', '', '<?php echo $item['id']; ?>');">
                        Удалить
                    </a>(
                    <a href="#" title="Колличество связей с Сообщениями (отправленными)"><?php echo $item['from_users_message']; ?></a>,
                    <a href="#" title="Колличество связей с Сообщениями (принятыми)"><?php echo $item['from_message']; ?></a>, 
                    <a href="#" title="Колличество связей с Транспортом посылок"><?php echo $item['from_package_transport_history']; ?></a>,
                    <a href="#" title="Колличество связей с Историей посылок"><?php echo $item['from_package_vcs']; ?></a>
                )</span>
            </td>
            <td align="center">
                <span>
                    <a href="/administration/user/edit/<?php echo $item['id']; ?>">
